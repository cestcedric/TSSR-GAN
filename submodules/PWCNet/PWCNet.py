...
from   submodules.PWCNet.correlation_package_pytorch1_0.correlation import Correlation #pytorch0.4 version
...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=4):
        ...
        #TODO: probably move to forward just as in https://github.com/NVlabs/PWC-Net/blob/master/PyTorch/models/PWCNet.py
        #FIXME: obviously stupid to set max size on upscaled frames
